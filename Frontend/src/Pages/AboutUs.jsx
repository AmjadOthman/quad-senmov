    ...
    <>
      ...
      <div className=" bg-white w-screen pb-10 flex flex-col items-center justify-center  gap-5">
        <div className=" justify-around items-center text-black text-base max-w-xl md:max-w-2xl lg:max-w-5xl mx-2 mt-20 text-left">
          Welcome to Senmov Pty Ltd, your premier partner for Nominee Director
          Services in Australia. With a commitment to excellence, compliance,
          and strategic business support, we are your gateway to a seamless and
          successful expansion into the Australian market.
        </div>
        ...
        <div className=" lg:max-w-7xl mx-auto flex flex-col items-center justify-center">
          ...
          <p className="justify-around items-center text-black text-base max-w-xl md:max-w-2xl lg:max-w-5xl mx-2 text-left">
            At Senmov Pty Ltd, we are a team of dedicated professionals with a
            passion for facilitating business growth. With years of experience
            in Australian corporate governance, we understand the challenges and
            opportunities that come with establishing and operating a business
        ...
        <div className=" lg:max-w-7xl mx-auto flex flex-col items-center justify-center">
          ...
          <p className="justify-around items-center text-black text-base max-w-xl md:max-w-2xl lg:max-w-5xl mx-2 text-left">
            ...
            Our goal is to go beyond compliance, offering strategic guidance and
            support to help you navigate the complexities of the Australian
            business landscape.
          </p>
        </div>
        <div className="w-full justify-around items-center text-black text-base max-w-xl md:max-w-2xl lg:max-w-5xl mx-2  text-left">
          <h2 className="text-gray-700 font-bold text-3xl lg:text-5xl mt-20 mb-5">
            Why choose SENMOV Pty Ltd?
          </h2>
